            ...
            <div className="bg-white shadow-md rounded-md mt-10 px-5 py-10">
                <form onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" name="name" id="name" className="mt-2 w-full p-3 bg-gray-50" placeholder="Tu Nombre" ref={nameRef} />
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation" className="mt-2 w-full p-3 bg-gray-50" placeholder="Repita la Contraseña" ref={passwordConfirmationRef} />
                    </div>
