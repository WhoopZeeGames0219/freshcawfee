  ...
  return (
    <aside className="w-72 h-screen overflow-y-scroll p-5">
      ...
      <form className='w-full' onSubmit={handleSubmit}>
        <div className='mt-5'>
          <input type="submit" className={`${comprobarPedido() ? 'bg-indigo-100' : 'bg-indigo-600 hover:bg-indigo-800'} px-5 py-2 rounded uppercase font-bold text-white w-full cursor-pointer`}
